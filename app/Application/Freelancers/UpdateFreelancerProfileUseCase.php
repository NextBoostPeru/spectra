...
class UpdateFreelancerProfileUseCase implements UseCase
{
    ...
    /**
     * @param array{freelancer_id:string,country_id:int,primary_currency_id:int,headline?:string|null,bio?:string|null,hourly_rate_min?:float|null,hourly_rate_max?:float|null,seniority_level?:string|null,availability_status?:string|null,skills?:list<array{skill:string,level:int}>} $input
     */
    public function __invoke(mixed $input): array
    {
        ...
        foreach (['freelancer_id', 'country_id', 'primary_currency_id'] as $required) {
